...
crosslinks:
  - { to: arrays-l2-sort-and-compare, why: "How string comparison interacts with array sorting" }
  - { to: strings-l2-utf16-code-units-vs-code-points, why: "Search indices are in code units; Unicode caveats" }
---
