...
crosslinks:
  - { to: arrays-l1-iteration-101, why: "Building strings in loops; when to switch to push+join" }
  - { to: strings-l1-trim-pad-repeat, why: "Composition with pad/repeat helpers for formatting" }
---
